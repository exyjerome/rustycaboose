...
var VueResource = __webpack_require__(11).default;
var VueTimers = __webpack_require__(13).default;
var VueRouter = __webpack_require__(15).default;
...
var routes = [{ path: '/', component: __webpack_require__(29) }, { path: '/vip', component: __webpack_require__(38) }];
...
function timer(name, time, options) {
  return Object(__WEBPACK_IMPORTED_MODULE_1__utils__["a" /* assign */])({ name: name, time: time }, options)
}
...
function generateData(timers) {
  return Object.keys(timers).reduce(function(acc, cur) {
    return Object(__WEBPACK_IMPORTED_MODULE_0__utils__["b" /* set */])(
      cur,
      {
        isRunning: false,
...
function normalizeOptions(options, vm) {
  return Array.isArray(options)
    ? options.reduce(function(res, config) {
      return Object(__WEBPACK_IMPORTED_MODULE_0__utils__["b" /* set */])(config.name, normalizeConfig(config, vm), res)
    }, {})
    : Object.keys(options).reduce(function(res, key) {
      return Object(__WEBPACK_IMPORTED_MODULE_0__utils__["b" /* set */])(
        key,
        normalizeConfig(Object(__WEBPACK_IMPORTED_MODULE_0__utils__["b" /* set */])('name', key, options[key]), vm),
        res
      )
    }, {})
}
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  created: function() {
    ...
    vm.$timer = {
      start: function(name) {
        if ("development" !== 'production' && !(name in options)) {
          throw new ReferenceError(
        ...
        data[name].instance = generateTimer(
          Object(__WEBPACK_IMPORTED_MODULE_0__utils__["b" /* set */])('time', data[name].time, options[name]),
          vm
        )
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6b294924", Component.options)
  } else {
    hotAPI.reload("data-v-6b294924", Component.options)
  }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-6b294924", module.exports)
  }
}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-05d4cbf4", Component.options)
  } else {
    hotAPI.reload("data-v-05d4cbf4", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    data: function data() {
        return {
            rusty: 'RUSTY'.split('').map(function (l) {
                return '<span>' + l + '</span>';
            }).join("\n"),
            caboose: 'caboose'.split('').map(function (l) {
                return '<span>' + l + '</span>';
            }).join("\n")
        };
    }
...
var render = function() {
  ...
  return _c("div", { staticClass: "logo-container" }, [
    _c("div", { staticClass: "logo-container__inner" }, [
      _c("div", {
        staticClass: "logo-container__top",
        domProps: { innerHTML: _vm._s(_vm.rusty) }
      }),
      _vm._v(" "),
      _c("div", {
        staticClass: "logo-container__bottom",
        domProps: { innerHTML: _vm._s(_vm.caboose) }
      })
    ])
  ])
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-05d4cbf4", module.exports)
  }
}
...
var render = function() {
  ...
  return _c(
    ...
    {
      staticClass:
        "navbar navbar-expand-lg navbar-expand-sm navbar-dark bg-dark mb-3"
    },
    [
      _c(
        "div",
        ...
        [
          _c(
            ...
            [_c("img", { attrs: { src: "/svg/eftwiki.svg", alt: "EFT Wiki" } })]
          ),
          _vm._v(" "),
          _vm._m(0),
          _vm._v(" "),
...
var staticRenderFns = [
  ...
  function() {
    ...
    return _c("li", { staticClass: "nav-item" }, [
      _c("a", { staticClass: "nav-link disabled" }, [_vm._v("loadout builder")])
    ])
  },
  function() {
    var _vm = this
    ...
    var _c = _vm._self._c || _h
    return _c("li", { staticClass: "nav-item" }, [
      _c("a", { staticClass: "nav-link disabled" }, [_vm._v("quests")])
    ])
  },
  function() {
    var _vm = this
    ...
    var _c = _vm._self._c || _h
    return _c("li", { staticClass: "nav-item" }, [
      _c("a", { staticClass: "nav-link disabled" }, [_vm._v("maps")])
    ])
  },
  function() {
    var _vm = this
    ...
    var _c = _vm._self._c || _h
    return _c("li", { staticClass: "nav-item" }, [
      _c("a", { staticClass: "nav-link disabled" }, [_vm._v("guides")])
    ])
  },
  function() {
    var _vm = this
    ...
    return _c("li", { staticClass: "nav-item" }, [
      _c(
        ...
        {
          staticClass: "nav-link",
          attrs: { href: "https://discord.me/ghv2", target: "_blank" }
        },
        [_vm._v("discord")]
      )
    ])
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-cfc91daa", module.exports)
  }
}
...
Component.options.__file = "components/SteamConnect.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7aa4f156", Component.options)
  } else {
    hotAPI.reload("data-v-7aa4f156", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        players: function players() {
            ...
            this.$http.get('https://rust-servers.net/api/?object=servers&element=detail&key=CwklHdcJj6tIwze2TovcG5FFbpPDQRmjZV').then(function (resp) {
                _this.api = resp.body;
            });
        }
    }
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "row or justify-content-center" }, [
    _c("div", { staticClass: "col-auto" }, [
      _c(
        "a",
        {
          staticClass: "button-outline",
          attrs: { href: "steam://connect/" + _vm.ip + ":" + _vm.port }
        },
        [
          ...
          _c("span", [
            _vm._v(
              _vm._s(_vm.text) +
                " " +
                _vm._s(_vm.api.players) +
                "/" +
                _vm._s(_vm.api.maxplayers)
            )
          ])
        ]
      )
      ...
      ? _c(
          ...
          [
            _c(
              "router-link",
              {
                staticClass: "button-outline button-outline--gold",
                attrs: { to: "/vip" }
              },
              [
                _c("i", { staticClass: "fas fa-star" }),
                _vm._v(" Skip the queue\n        ")
              ]
            )
          ],
          1
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-7aa4f156", module.exports)
  }
}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-01a29953", Component.options)
  } else {
    hotAPI.reload("data-v-01a29953", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "container" }, [_c("steam-connect")], 1)
}
var staticRenderFns = []
render._withStripped = true
module.exports = { render: render, staticRenderFns: staticRenderFns }
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-01a29953", module.exports)
  }
}
...
Component.options.__file = "views/vip.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-f2157d44", Component.options)
  } else {
    hotAPI.reload("data-v-f2157d44", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    data: function data() {
        return {
            items: ['Reserved Slot', 'Unique Tag Ingame', 'Input on new maps', 'Increased Tool Durability (25%)']
        };
    }
});
...
var staticRenderFns = [
    ...
    return _c("div", { staticClass: "row justify-content-center" }, [
      _c("div", { staticClass: "col-12 pb-3" }, [
        _c("p", { staticClass: "text-muted text-center" }, [
          _vm._v("Monthly Donation Goal")
        ]),
        _vm._v(" "),
        _c(
          "div",
          {
            staticClass: "progress progress--gold",
        ...
        _vm._v(" "),
        _c("p", { staticClass: "progress-amount" }, [
  ...
  function() {
    ...
    return _c(
      "a",
      {
        staticClass: "list-group-item list-group-item--gold",
        attrs: { href: "#" }
      },
      [
        _c("i", { staticClass: "fas fa-star" }),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-f2157d44", module.exports)
  }
}
